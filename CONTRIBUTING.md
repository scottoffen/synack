...
A lot of issues that were created in previous versions of Synack were not bugs or feature requests, they were questions or discussions - most of which could be (and were) answered by anyone in the community; they're not exclusive to the maintainers. For feedback like this, there are several places where people can get all kinds of help, and we would encourage you to use them first.

- Consult the [official documentation](https://scottoffen.github.io/Synack).
- Engage in our [community discussions](https://github.com/scottoffen/Synack/discussions).
- Ask your question on [StackOverflow](https://stackoverflow.com) using [#Synack](https://stackoverflow.com/questions/tagged/Synack?sort=newest).
...
- Include the details of the operating system and version, version of .NET and the version of Synack you are using.
...
Synack is written strictly in C#. The repository includes an [`.editorconfig`](https://editorconfig.org/) file to manage indentation styles as well as line endings, etc.
...
Having excellent documentation is crucial to the success of Synack. Documentation for Synack is written using [Docusaurus](https://docusaurus.io/), lives in [docs folder](./docs/). Your contribution of clear, concise and accurate documentation is appreciated.